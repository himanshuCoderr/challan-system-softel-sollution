...
async function getChallans() {
    try {
        ...
        const res = await axios.get("https://apisalon.softelsolutions.in/api/VehicleTow/VehicleTowEntryList" ,{  headers: {
            "Authorization": `Bearer ${token}`,
            "Content-Type": "application/json"
        }})
...
export { getChallansCategory, getChallansResons , addChallan , getChallans}